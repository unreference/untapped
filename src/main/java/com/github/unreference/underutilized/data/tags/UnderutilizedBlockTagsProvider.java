...
public final class UnderutilizedBlockTagsProvider extends FabricTagProvider.BlockTagProvider {
  public UnderutilizedBlockTagsProvider(
  ...
  protected void addTags(HolderLookup.Provider provider) {
    this.valueLookupBuilder(UnderutilizedBlockTags.STAINED_GLASS)
        .add(
    ...
    this.valueLookupBuilder(UnderutilizedBlockTags.STAINED_GLASS_PANES)
        .add(
